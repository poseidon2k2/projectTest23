...
let cartItems = [];
let cartTotal = 0;
const boxCheckElement = document.getElementById('BoxCheck');
...
function addToCart(productName, productPrice, productImageUrl) {
    ...
    if (existingProduct) {
        ...
        cartItems.push({ name: productName, price: productPrice, image: productImageUrl, quantity: 1 });
    }
        ...
        listItem.innerHTML = `
            <div class="App_cartItem_lfA9I">
                <div class="App_cartItemLeft_1HqDk cartItemLeft">
                    <div class="App_cartItemImage_1rLvq cartItemImage" style="background-color: rgb(225, 231, 237);">
